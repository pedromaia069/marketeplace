    ...
    <div class="container" id="wrap">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <form action="save_user.php" id="cad" method="post" accept-charset="utf-8" class="form" role="form">   <legend>Novo usuário</legend>
                    <h4>Por favor preencha o formulário.</h4>
                    <span id="erro"><?php echo $erro; ?></span>
                    <div class="row">
                    ...
                    <input type="text" name="email"  onkeypress="teste(this.name);"  value="" class="form-control input-lg" placeholder="E-mail"  />
